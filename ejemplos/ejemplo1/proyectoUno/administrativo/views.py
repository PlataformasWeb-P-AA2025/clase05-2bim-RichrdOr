...
# @login_required(login_url='/entrando/login/') se coloca login_required porque se optimiza el proceso al poner la url ya que se hace referencia desde el settings.py
@login_required
